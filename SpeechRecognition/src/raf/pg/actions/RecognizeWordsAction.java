...
public class RecognizeWordsAction extends AbstractSRAction{

	public RecognizeWordsAction() {
	...
	public void actionPerformed(ActionEvent e) {
		...
		AppCore.getInstance().showDetectedWordsRecognize(AppCore.getInstance().getRecDinamicPanel(), words, streams);
